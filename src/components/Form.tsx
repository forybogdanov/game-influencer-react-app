...
const Form = (props: IFormProps) => {
  ...
  return (
    <StyledForm>
      <Typography className={classes.campaignTitle} variant="h1">
        Add Campaign
      </Typography>
      <FormGroup>
          ...
          <FormControlLabel
            ...
            control={
              <Checkbox
                ...
                onChange={(e) => setPaidWithCrypto(e.currentTarget.checked)}
              ></Checkbox>
            }
          />
        </FormControl>
        ...
        <FormControl>
          <Button
            className={classes.submitCampaignButton}
        ...
        <FormControl>
          <Button className={classes.closeFormButton} onClick={closeForm}>
            Close
          </Button>
        </FormControl>
      </FormGroup>
