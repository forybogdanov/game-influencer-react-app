...
const Campaign = (props: ICampaignProps) => {
  ...
  return (
    <StyledCampaign>
      <Typography className={classes.campaignName} variant="h1">
        {campaign.name}
      </Typography>
      <Typography className={classes.campaignStartDate} variant="body1">
        Start date: {campaign.startDate}
      </Typography>
      <Typography className={classes.campaignBudget} variant="body1">
        Budget: {campaign.budget}
      </Typography>
      <Typography className={classes.campaignLanguage} variant="body1">
